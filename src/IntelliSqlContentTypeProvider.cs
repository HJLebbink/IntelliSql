...
namespace AsmDude.SyntaxHighlighting
{
    ...
    [Name("IntelliSqlContentTypeProvider")]
    internal static class IntelliSqlContentTypeProvider
    {
        [Export]
        [FileExtension(".xxx")]
        [ContentType(IntelliSqlPackage.ThisContentType)]
        internal static FileExtensionToContentTypeDefinition SqlFileType = null;
    }
}
